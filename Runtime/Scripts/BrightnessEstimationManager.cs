...
namespace PassthroughCameraSamples.BrightnessEstimation
{
    ...
    [System.Serializable]
    public struct STRUCT_CusrorColor {

        public Color32 m_center;
        [Header("Arrow Colors")]
        public Color32 m_top;
        public Color32 m_right;
        public Color32 m_bottom;
        public Color32 m_left;

        [Header("Corner Colors")]
        public Color32 m_topLeft;
        public Color32 m_topRight;
        public Color32 m_bottomLeft;
        public Color32 m_bottomRight;

    }

    public class QuestCamMono_ColorPoints : MonoBehaviour
    {
        ...
        public Color[] m_colorPoints;

        public STRUCT_CusrorColor m_borderColor;
        public int m_cursorPixelSize = 10;
        public STRUCT_CusrorColor m_centerCursorColor;
